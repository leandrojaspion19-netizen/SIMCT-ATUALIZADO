...
const MonitoringDashboard: React.FC<MonitoringDashboardProps> = ({ 
  ...
  const getStatusStyle = (prazo: string) => {
    ...
    if (diffDays <= 2) return { bg: 'bg-orange-50 text-orange-700 border-orange-200', text: 'VENCE EM BREVE' };
    return { bg: 'bg-green-50 text-green-700 border-green-200', text: 'DENTRO DO PRAZO' };
  };
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-[#E5E7EB]">
              {filteredMonitoringDocs.map(doc => {
                ...
                const style = getStatusStyle(monitoring.prazoEsperado);
