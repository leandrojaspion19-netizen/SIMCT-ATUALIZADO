...
export const BAIRROS = [
  ...
  "JARDIM GOLDEN PARK", "JARDIM GOLDEN PARK", "JARDIM GREEN PARK", "PARQUE DO HORTO", "JARDIM INTERLAGOS", 
...
export const ATRIBUICOES_136_ECA = [
  ...
  { id: 'X', label: 'X - Representar, em nome da pessoa e da família, contra a violação dos direitos previstos nos art. 204, inciso II, da Constituição.' },
